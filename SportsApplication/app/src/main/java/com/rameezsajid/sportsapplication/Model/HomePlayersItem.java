...
public class HomePlayersItem {
    ...
    public HomePlayersItem(String firstName, String lastName, int shirt, String position, Boolean captain, int goalsConceded, int goalsScored, int assists,
